    ...
    <div class='absolute top-2 left-3 md:top-3
       ...
       <p class='font-semibold text-base md:text-xl'>{{ $slot }}</p>
        <div>
            ...
            <span class="text-sm md:text-base">{{ $startDate }}</span> au
            <span class="text-sm md:text-base">{{ $endDate }}</span>
            <span class="text-sm md:text-base">{{ $year }}</span>
        </div>
        <div>
            <i class="fa-solid fa-map-marker" aria-hidden="true"></i>
            <span class="text-sm md:text-base">{{ $place }}</span>
        </div>
    </div>
