<!-- Profile Info Block -->
<div x-data="{ loaded: false }" class="py-4 flex flex-col items-center text-center overflow-hidden">
    ...
    <img
        ...
        x-cloak
        alt="Avatar"
        :class="[sidebarOpen ? 'size-35' : 'size-10', loaded ? 'opacity-100' : 'opacity-0']"
